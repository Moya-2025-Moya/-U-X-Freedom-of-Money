...
export default function NotFound() {
  const pages = [
    { href: '/',          label: 'Campaign',  desc: 'Main landing page' },
    { href: '/purchase', label: 'Order',     desc: 'Buy a copy with $U' },
    { href: '/swap',     label: 'Get $U',    desc: 'Swap any token into $U' },
    { href: '/track',    label: 'Track Order', desc: 'Check your delivery status' },
    { href: '/details',  label: 'About',     desc: 'How it works + FAQ' },
  ];
  return (
