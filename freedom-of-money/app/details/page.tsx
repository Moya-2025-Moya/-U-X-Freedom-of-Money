      ...
      <div style={{ background: BG, minHeight: '100vh', fontFamily: 'system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', color: TEXT }}>
        ...
        <nav style={{ padding: '14px 24px', display: 'flex', justifyContent: 'center', position: 'sticky', top: 0, zIndex: 100 }}>
          <div style={{
            ...
            <a href="/" style={{ fontSize: 12, color: MUTED, textDecoration: 'none' }}>Campaign</a>
            <a href="/swap" style={{ fontSize: 12, color: MUTED, textDecoration: 'none' }}>Get $U</a>
          ...
          <section style={{ marginBottom: 56 }}>
            ...
            <div>
              ...
              <QA
                ...
                a="Use your transaction hash or wallet address at /track. Your order status updates as we process, ship, and deliver."
              />
              <QA
        ...
        <footer style={{ borderTop: `1px solid ${BORDER}`, padding: '32px 24px' }}>
          <div style={{ maxWidth: 640, margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
            ...
            <div style={{ display: 'flex', gap: 16, fontSize: 11, color: MUTED, flexWrap: 'wrap', justifyContent: 'center' }}>
              <a href="/" style={{ color: MUTED, textDecoration: 'none' }}>Campaign</a>
              <a href="/swap" style={{ color: MUTED, textDecoration: 'none' }}>Get $U</a>
              <a href="/track" style={{ color: MUTED, textDecoration: 'none' }}>Track Order</a>
